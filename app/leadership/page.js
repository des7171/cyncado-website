  ...
  const leaders = [
    {
      ...
      bio: 'Bio information to be added.',
    },
    {
    ...
    <main>
      ...
      <section style={{
        ...
        <div style={{
          ...
          width: '600px',
          height: '600px',
          background: 'radial-gradient(circle, rgba(21, 159, 106, 0.06) 0%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        <div style={{
          position: 'absolute',
          ...
          width: '500px',
          height: '500px',
          background: 'radial-gradient(circle, rgba(162, 206, 34, 0.05) 0%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ 
            ...
            Our team brings decades of experience in drug development, 
            oncology research, and building successful biotech companies.
          </p>
            ...
            {leaders.map((leader, index) => (
              ...
              >
                ...
                <div style={{
                  ...
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#159F6A" strokeWidth="1.5">
          ...
          {/* Note about updating */}
          <div style={{
            background: 'rgba(21, 159, 106, 0.05)',
            border: '1px solid rgba(21, 159, 106, 0.15)',
            borderRadius: '12px',
            padding: '20px 24px',
            marginBottom: '40px',
            textAlign: 'center',
            ...
            <p style={{ fontSize: '14px', color: '#666' }}>
              Leadership information will be updated with full bios and photos.
            </p>
          </div>
